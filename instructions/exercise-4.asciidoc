...
* stem:[Cost_{boundary}(B) = \left((-\sin\theta(0),\cos\theta(0),0)|\dot{B}(0)\right)^2 + \left((-\sin\theta(1),\cos\theta(1),0)|\dot{B}(1)\right)^2] is a cost that enforces that the velocity in the plane is oriented along the direction of stem:[\theta] at at 0 and 1.
